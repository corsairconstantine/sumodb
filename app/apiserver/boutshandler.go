...
func (s *APIserver) getBouts(w http.ResponseWriter, r *http.Request) {
	db := s.store.Db
...
func (s *APIserver) addBout(w http.ResponseWriter, r *http.Request) {
	db := s.store.Db
	var newbout bout
	...
	s.logger.Printf("Added a bout at id: %v\n", id)
}
